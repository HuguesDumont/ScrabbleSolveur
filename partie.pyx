...
cdef class Partie :
   ...
   cpdef void piocher(self):
       while len(self.joueur.chevalet) <7 :
           if(self.demo) :
            self.joueur.ajouterLettre(self.pioche[0])
            del self.pioche[0]
           else :
   ...
   cpdef void afficherPioche(self):
     for lettre in self.pioche:
        print(lettre)


   cpdef void PlacerMot(self,mot):
